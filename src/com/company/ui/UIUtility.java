...
public class UIUtility {
    ...
    public static JTextField createField(String key) {
        JTextField fld = new JTextField(key);
        setOrientation(fld);
        return fld;
    }

    public static JPasswordField createPasswordField(String key) {
        JPasswordField fld = new JPasswordField(key);
        setOrientation(fld);
        return fld;
    }
